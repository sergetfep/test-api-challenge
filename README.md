...
- Есть API, которое умеет получать шутки Чака Норриса - https://api.chucknorris.io/.
...
- Также нужно создать кнопку, которая добавляет шутку в лист любимых шуток, и, если нажать еще раз она ее, удалит из листа и при перезагрузке страницы они должны сохраняться (используйте localStorage).
...
- Также нужно создать кнопку, которая очищает лист любимых шуток.

- Уделите вниманию блокам в листе любимых шуток:
